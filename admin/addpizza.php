...
if($_SERVER['REQUEST_METHOD']=='POST')
{
	...
	$sql="insert into pizzamaster_tbl values(NULL,'$fname','$pic','$spec','$price','$cid')";
...
<!========================================Form=========================================================>           <br/>     
 ...
 <div class="control-group success">
              <label class="control-label" for="inputError"><strong>Pizza Name</strong></label>
                 <div class="controls">
                    <input class="input-xlarge focused" id="focusedInput" type="text" name="fname">
                 </div>
        </div>  
		
		 <div class="control-group success">
              <label class="control-label" for="inputError"><strong>Pizza Details</strong></label>
                 <div class="controls">
                    <textarea name="pspec" class="input-xlarge focused" id="focusedInput"></textarea>
                 </div>
        </div>  
        ...
        <div class="control-group success">
              <label class="control-label" for="inputError"><strong>Pizza Image</strong></label>
                 <div class="controls">
                    <input name="fil" type="file" class="input-xlarge focused" id="focusedInput" >
                 </div>
        </div>
         <div class="control-group success">
