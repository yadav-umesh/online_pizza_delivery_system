...
<html>
	...
	<title>PIZZAHOME &mdash;we deliver the best pizza at your doorstep</title>
				...
				<div class="col-md-12 col-md-offset-0 text-left">
					...
					<div class="row row-mt-15em">
						<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
							<span class="intro-text-small">Hand-crafted by <a href="http://gettemplates.co" target="_blank">pizzahome.com</a></span>
								...
								<div class="tab">
									...
									<div class="tab-content">
										<div class="tab-content-inner active" data-content="signup">
											<h3 class="cursive-font">PIZZA ORDER</h3>
											<!--<form action="#">
	...
	<div class="gtco-section">
		<div class="gtco-container">
			...
			<div class="row">
              <?php
              $sql="select * from pizzamaster_tbl LIMIT 4";
			...
			?>
				...
				<div class="col-lg-4 col-md-4 col-sm-6">
					<a href="admin/upload/<?php echo $d['fpic'];?>" class="fh5co-card-item image-popup">
						<figure>
							<div class="overlay"><i class="ti-plus"></i></div>
							<img src="admin/upload/<?php echo $d['fpic'];?>" alt="Image" class="img-responsive">
						</figure>
						<div class="fh5co-text">
							<h2><?php echo $d['fname'];?></h2>
							<p><?php echo $d['fspec'];?></p>
							<p><span class="price cursive-font"><?php echo $d['fprice'];?></span></p>
						</div>
					</a>
					<!--<a href="login.php ?id=<?php echo $d['fid'];?>"><div style="height:55px;width:200px;border-radius:15px;margin-left: 55px;text-align:center;font-size:18px;padding-top: 10px;margin-top: 0;"><button type="submit" class="btn btn-outline btn-warning">BOOK NOW</button></div></a>-->
				</div>
                <?php
			}
			?>
