			...
			<div class="row">
				...
				<div class="col-xs-8 text-right menu-1">
					<ul>
						...
						<li class="btn-cta"><a href="#"><span>Order Now</span></a></li>
					</ul>	
				</div>
			</div>
				...
				<div class="col-md-5 col-md-push-1 animate-box">
					...
					<div class="gtco-contact-info">
						...
						<ul>
                            ...
                            <li class="#"><?php echo $d['cname'];?></li>
							<li class="address"><?php echo $d['caddress'];?></li>

							<li class="phone"><?php echo $d['cphone'];?></li>
							<li class="email"><?php echo $d['cemail'];?></li>
